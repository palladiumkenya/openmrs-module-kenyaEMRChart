...
(case nutritional_status when 1115 then "Normal" when 164125 then "Nutritional wasting" when 164131 then "Severe (-3 SD and -4 SD)" when 123815 then "Moderate (-2 SD)" when 123814 then "Mild (-1 SD)" when 163302 then "Severe acute malnutrition" when 163303 then "Moderate acute malnutrition" when 114413 then "Overweight" when 115115 then "Obese" end) as nutritional_status,
