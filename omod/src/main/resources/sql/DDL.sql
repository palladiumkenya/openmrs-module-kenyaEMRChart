...
SELECT "Successfully created etl_ART_preparation table";
  ...
  CREATE TABLE kenyaemr_etl.etl_patient_triage (
    ...
    diastolic_pressure DOUBLE,
    temperature DOUBLE,
    sari_fever_measured INT(11),
    sari_cough_measured INT(11),
    sari_onset_symptoms INT(11),
    pulse_rate DOUBLE,
    respiratory_rate DOUBLE,
    oxygen_saturation DOUBLE,
    muac DOUBLE,
    ...
    sexual_abstained INT(11),
    lmp_in_last_seven_days INT(11),
    family_planing INT(11),
    miscarriage INT(11),
    baby_in_last_week INT(11),
    refer_client_for_pregnancy INT(11),
