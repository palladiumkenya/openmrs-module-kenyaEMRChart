...
DROP FUNCTION IF EXISTS kenyaemr_etl.fn_getPatientNameDoubleMetaphone$$

CREATE FUNCTION kenyaemr_etl.fn_getPatientNameDoubleMetaphone(st VARCHAR(55)) RETURNS varchar(128) CHARSET utf8
    NO SQL
BEGIN
