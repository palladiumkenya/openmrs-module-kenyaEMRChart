...
DROP PROCEDURE IF EXISTS sp_populate_etl_orthopaedic_clinic_visit $$
  ...
  BEGIN
    ...
    from encounter e
      ...
      inner join obs o on o.encounter_id = e.encounter_id and o.concept_id in (164181,161643,162724,168146,166635,159893,5219,167992,1731,
               162642,160430,1628,159520,168148,166635,160715,163393,165034,162747,166635,1081,1128,166635,164936,165285,165139,
...
CALL sp_populate_etl_orthopaedic_clinic_visit();
