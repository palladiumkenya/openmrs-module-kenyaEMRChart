...
inner join obs o on o.encounter_id = e.encounter_id and o.concept_id in (165383,1788,163042,165267,163731,159449,163201,1169,5096,1887,165268,1169,164181,160288,161011,1729,160632,162964,160592,159931,1546,164879)
inner join (
             select
               o.person_id,
               o.encounter_id,
