...
DROP PROCEDURE IF EXISTS sp_populate_etl_occupational_therapy_clinical_visit $$
CREATE PROCEDURE sp_populate_etl_occupational_therapy_clinical_visit()
	BEGIN
...
CALL sp_populate_etl_occupational_therapy_clinical_visit();
