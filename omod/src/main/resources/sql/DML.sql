...
e.creator,
e.date_created,
if(max(o.date_created)!=min(o.date_created),max(o.date_created),NULL) as last_modified_date,
	...
	BEGIN
		...
		INSERT INTO kenyaemr_etl.etl_patient_program(
			...
			select
				...
				pp.date_created,
				pp.date_changed as last_modified_date,
				pp.voided
	...
	BEGIN
      ...
      voided
			...
			select
			  ...
			  pc.uuid,
        pc.date_created,
        pc.date_changed as last_modified_date,
        pc.first_name,
        pc.middle_name,
        pc.last_name,
        pc.sex,
...
CREATE PROCEDURE sp_populate_etl_client_trace()
	BEGIN
      ...
      voided
        ...
        ct.uuid,
        ct.date_created,
        ct.date_changed as last_modified_date,
        ct.encounter_date,
        ct.client_id,
        ct.contact_type,
        ct.status,
