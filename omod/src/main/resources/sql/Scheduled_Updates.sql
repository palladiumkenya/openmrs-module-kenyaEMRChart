...
clinical_notes=VALUES(clinical_notes),voided=VALUES(voided);
    ...
    END $$
-- ---------------------- sp_update_etl_occupational_therapy_clinical_visit-------------------------------

DROP PROCEDURE IF EXISTS sp_update_etl_occupational_therapy_clinical_visit $$
CREATE PROCEDURE sp_update_etl_occupational_therapy_clinical_visit(IN last_update_time DATETIME)
  BEGIN
    SELECT "Processing occupational therapy clinical visit ", CONCAT("Time: ", NOW());
    insert into kenyaemr_etl.etl_occupational_therapy_clinical_visit(
      uuid,
      patient_id,
      visit_id,
      visit_date,
      ...
      from encounter e
        ...
        left outer join obs o on o.encounter_id=e.encounter_id and o.voided=0
                                 and o.concept_id in (164181,160338,160478,160632,164812,160336,162558,1069,167273,165241,165911,
                                 160632,160430,165302,160632,164204,164406,168360,160632,161011,160433,160632,163145,162724,1640,
                                 162879,162477,1655,1000075,1896)
      where e.voided=0 and e.date_created >= last_update_time
            or e.date_changed >= last_update_time
            or e.date_voided >= last_update_time
            or o.date_created >= last_update_time
    ...
    ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),encounter_provider=VALUES(encounter_provider),
            visit_type=VALUES(visit_type),
             ...
             specify_referring_department=VALUES(specify_referring_department),
             specify_referring_department_other=VALUES(specify_referring_department_other),
             occupational_therapy_number=VALUES(occupational_therapy_number),
             patient_enrolled_in_school=VALUES(patient_enrolled_in_school),
             patient_with_disability=VALUES(patient_with_disability),
             disability_type=VALUES(disability_type),
             neurodevelopmental_finding_type=VALUES(neurodevelopmental_finding_type),
             learning_findings=VALUES(learning_findings),
             neurodiversity_conditions=VALUES(neurodiversity_conditions),
             neurodiversity_conditions_other=VALUES(neurodiversity_conditions_other),
             general_clinical_notes=VALUES(general_clinical_notes),
             ot_intervention=VALUES(ot_intervention),
             ot_intervention_other=VALUES(ot_intervention_other),
             assistive_technology=VALUES(assistive_technology),
             service_offered=VALUES(service_offered),
             therapeutical_intervention=VALUES(therapeutical_intervention),
             therapeutical_intervention_other=VALUES(therapeutical_intervention_other),
             remarks=VALUES(remarks),
             patient_outcome=VALUES(patient_outcome),
             referral_for=VALUES(referral_for),
             ...
             admission_male_ward=VALUES(admission_male_ward),
...
CREATE PROCEDURE sp_scheduled_updates()
  BEGIN
    ...
    CALL sp_update_etl_occupational_therapy_clinical_visit(last_update_time);
