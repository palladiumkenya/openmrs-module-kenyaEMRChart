...
max(if(o.concept_id=160535,trim(o.value_text),null)) as facility_transferred_from,
max(if(o.concept_id=161551,trim(o.value_text),null)) as district_transferred_from,
...
max(if(o.concept_id=160632,trim(o.value_text),null)) as facility_confirmed_hiv_positive,
max(if(o.concept_id=160533,o.value_boolean,null)) as arv_status,
max(if(o.concept_id=160638,trim(o.value_text),null)) as name_of_treatment_supporter,
max(if(o.concept_id=160640,o.value_coded,null)) as relationship_of_treatment_supporter,
max(if(o.concept_id=160642,trim(o.value_text),null)) as treatment_supporter_telephone ,
max(if(o.concept_id=160641,trim(o.value_text),null)) as treatment_supporter_address,
e.voided
from encounter e 
inner join 
(
...
max(if(o.concept_id=160430,trim(o.value_text),null)) as clinical_notes ,
...
max(if(o.concept_id=159495, trim(o.value_text), null)) as to_facility,
...
-- max(if(o.concept_id=161655,trim(o.value_text),null)) as date_of_discontinuation,
...
max(if(o.concept_id=5089,o.value_numeric,null)) as weight,
max(if(o.concept_id=5090,o.value_numeric,null)) as height,
max(if(o.concept_id=160638,trim(o.value_text),null)) as treatment_supporter,
max(if(o.concept_id=160640,o.value_coded,null)) as relation_to_patient,
max(if(o.concept_id=160641,trim(o.value_text),null)) as treatment_supporter_address,
max(if(o.concept_id=160642,trim(o.value_text),null)) as treatment_supporter_phone_contact,
...
-- max(if(o.concept_id=162086,trim(o.value_text),null)) as dna_pcr_dbs_sample_code,
...
-- max(if(o.concept_id=162086,trim(o.value_text),null)) as first_antibody_dbs_sample_code,
...
-- max(if(o.concept_id=162086,trim(o.value_text),null)) as final_antibody_dbs_sample_code,
