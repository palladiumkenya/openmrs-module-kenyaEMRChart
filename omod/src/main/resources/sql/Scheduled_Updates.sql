    ...
    insert into kenyaemr_etl.etl_laboratory_extract(
      ...
      select
        ...
        (case when o.concept_id in(5497,730,654,790,856) then o.value_numeric
         when o.concept_id in(1030,1305,1325,159430,161472,1029,1031,1619,1032,162202,307,45,167718,163722) then o.value_coded END) AS test_result,
...
CREATE PROCEDURE sp_update_etl_patient_triage(IN last_update_time DATETIME)
  BEGIN
    ...
    ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),encounter_provider=VALUES(encounter_provider),weight=VALUES(weight),height=VALUES(height),systolic_pressure=VALUES(systolic_pressure),diastolic_pressure=VALUES(diastolic_pressure),
      ...
      oxygen_saturation=VALUES(oxygen_saturation),muac=VALUES(muac),nutritional_status=VALUES(nutritional_status),last_menstrual_period=VALUES(last_menstrual_period),hpv_vaccinated=VALUES(hpv_vaccinated),voided=VALUES(voided);
...
-- Update Mortality Audit ----
DROP PROCEDURE IF EXISTS sp_update_etl_mortality_audit $$
CREATE PROCEDURE sp_update_etl_mortality_audit(IN last_update_time DATETIME)
BEGIN
SELECT "Mortality Audit", CONCAT("Time: ", NOW());
...
from encounter e
    ...
    inner join obs o on o.encounter_id = e.encounter_id and o.concept_id in (162728,164415,163783,162728,165399,159948,166665,161011,163105,166555,167452,1651,166664,1792,1282,165145,163105,166665,167459,164500,160051,162309,160646,162760,160759,159935,1193,160632,163752,161011,164368,159957,1417,162309,1342,1343,162584,163304,166484,159792,160759,159935,162820, 162760,164879,159394,161602,1687,165399,165430,166937,1814,161011,1599,162169,164378) and o.voided=0
where e.voided=0 and e.date_created >= last_update_time
   or e.date_changed >= last_update_time
   or e.date_voided >= last_update_time
   or o.date_created >= last_update_time
...
ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),
    provider=VALUES(provider),
      patient_type =VALUES(patient_type),
      tibu_id =VALUES(tibu_id),
      maternal_haart =VALUES(maternal_haart),
      io_perinatal_period =VALUES(io_perinatal_period),
      io_perinatal_specify =VALUES(io_perinatal_specify),
      io_perinatal_specify_date =VALUES(io_perinatal_specify_date),
      io_perinatal_treatment =VALUES(io_perinatal_treatment),
      io_perinatal_treatment_specify =VALUES(io_perinatal_treatment_specify),
      oi_perinatal_status =VALUES(oi_perinatal_status),
      crag_cd4 =VALUES(crag_cd4),
      crag_results =VALUES(crag_results),
      lumbar_puncture =VALUES(lumbar_puncture),
      results_in_lumbar_puncture =VALUES(results_in_lumbar_puncture),
      positive_lumbar_puncture =VALUES(positive_lumbar_puncture),
      antifungal_regimen =VALUES(antifungal_regimen),
      antifungal_regimen_specify =VALUES(antifungal_regimen_specify),
      treated_lumbar_puncture =VALUES(treated_lumbar_puncture),
      fluconazole_given =VALUES(fluconazole_given),
      tb_lam =VALUES(tb_lam),
      tb_lam_diagnosis =VALUES(tb_lam_diagnosis),
      type_of_tb =VALUES(type_of_tb),
      tb_treated_given =VALUES(tb_treated_given),
      treatment_adr =VALUES(treatment_adr),
      adr_reaction =VALUES(adr_reaction),
      adr_severity =VALUES(adr_severity),
      anti_tb_medication =VALUES(anti_tb_medication),
      suspected_drug  =VALUES(suspected_drug),
      suspected_drug_specify  =VALUES(suspected_drug_specify),
      tb_diagnosis =VALUES(tb_diagnosis),
      tb_diagnosis_specify =VALUES(tb_diagnosis_specify),
      tb_type_diagnosis =VALUES(tb_type_diagnosis),
      confirm_drug_resistance =VALUES(confirm_drug_resistance),
      specify_drug_resistance  =VALUES(specify_drug_resistance),
      initiated_anti_tb_treatment =VALUES(initiated_anti_tb_treatment),
      bmi =VALUES(bmi),
      muac =VALUES(muac),
      z_score =VALUES(z_score),
      anthropometric_findings =VALUES(anthropometric_findings),
      intensive_phase_tb__treatment =VALUES(intensive_phase_tb__treatment),
      continuation_phase_tb__treatment =VALUES(continuation_phase_tb__treatment),
      adverse_reactions =VALUES(adverse_reactions),
      reaction =VALUES(reaction),
      severity =VALUES(severity),
      drug_interactions =VALUES(drug_interactions),
      drug_interactions_specify =VALUES(drug_interactions_specify),
      diagnosed_opportunistic =VALUES(diagnosed_opportunistic),
      specify_diagnosed_opportunistic =VALUES(specify_diagnosed_opportunistic),
      ncd_comorbidity =VALUES(ncd_comorbidity),
      specify_other_ncd_comorbidity =VALUES(specify_other_ncd_comorbidity),
      ncd_risk_factor =VALUES(ncd_risk_factor),
      ncd_controlled =VALUES(ncd_controlled),
      death_contribution =VALUES(death_contribution),
      death_contribution_specify =VALUES(death_contribution_specify),
      death_cause =VALUES(death_cause),
      gap_noted =VALUES(gap_noted),
...
CREATE PROCEDURE sp_scheduled_updates()
  BEGIN
    ...
    CALL sp_update_etl_mortality_audit(last_update_time);
