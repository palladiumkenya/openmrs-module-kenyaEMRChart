...
CREATE PROCEDURE sp_update_etl_prep_behaviour_risk_assessment(IN last_update_time DATETIME)
  BEGIN
    ...
    insert into kenyaemr_etl.etl_prep_behaviour_risk_assessment(
        ...
        decline_reason_none,
        decline_reason_side_effects,
        decline_reason_stigma,
        decline_reason_pill_burden,
        decline_reason_many_HIV_tests,
        decline_reason_long_pills_intake,
        risk_edu_offered,
        risk_education,
      ...
      select
          ...
          max(if(o.concept_id = 163310 and o.value_coded = 162185, "Detectable viral load",NULL)) as VL_level,
          max(if(o.concept_id = 163310 and o.value_coded = 160119, "On ART for less than 6 months",NULL)) as duration_on_ART,
          max(if(o.concept_id = 163310 and o.value_coded = 160571, "Couple is trying to concieve",NULL)) as attempting_pregnancy,
          max(if(o.concept_id = 163310 and o.value_coded = 159598, "Suspected poor adherence",NULL)) as poor_adherence,
          max(if(o.concept_id = 160581, (case o.value_coded when 1065 then "High risk partner" else NULL end), "" )) as high_risk_partner,
          max(if(o.concept_id = 159385, (case o.value_coded when 1065 then "Yes" end), NULL )) as sex_with_multiple_partners,
          max(if(o.concept_id = 141814, (case o.value_coded when 1065 then "Yes" end), NULL )) as ipv_gbv,
          max(if(o.concept_id = 160579, (case o.value_coded when 1065 then "Yes" end), NULL )) as transactional_sex,
          max(if(o.concept_id = 156660, (case o.value_coded when 1065 then "Yes" end), NULL )) as recent_sti_infected,
          max(if(o.concept_id = 164845, (case o.value_coded when 1065 then "Yes" end), NULL )) as recurrent_pep_use,
          max(if(o.concept_id = 165088, (case o.value_coded when 1065 then "Yes" end), NULL )) as recurrent_sex_under_influence,
          max(if(o.concept_id = 165089, (case o.value_coded when 1065 then "Yes" end), NULL )) as inconsistent_no_condom_use,
          max(if(o.concept_id = 165090, (case o.value_coded when 1065 then "Yes" end), NULL )) as sharing_drug_needles,
          ...
          max(if(o.concept_id = 1743 and o.value_coded = 1107,  "None",NULL)) as decline_reason_none,
          max(if(o.concept_id = 1743 and o.value_coded = 159935,  "Side effects(ADR)",NULL)) as decline_reason_side_effects,
          max(if(o.concept_id = 1743 and o.value_coded = 164997,  "Stigma",NULL)) as decline_reason_stigma,
          max(if(o.concept_id = 1743 and o.value_coded = 160588,  "Pill burden",NULL)) as decline_reason_pill_burden,
          max(if(o.concept_id = 1743 and o.value_coded = 164401,  "Too many HIV tests",NULL)) as decline_reason_many_HIV_tests,
          max(if(o.concept_id = 1743 and o.value_coded = 161888,  "Taking pills for a long time",NULL)) as decline_reason_long_pills_intake,
    ...
    ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),
      ...
      VL_level=VALUES(VL_level),
      duration_on_ART=VALUES(duration_on_ART),
      attempting_pregnancy=VALUES(attempting_pregnancy),
      poor_adherence=VALUES(poor_adherence),
      ...
      decline_reason_none=VALUES(decline_reason_none),
      decline_reason_side_effects=VALUES(decline_reason_side_effects),
      decline_reason_stigma=VALUES(decline_reason_stigma),
      decline_reason_pill_burden=VALUES(decline_reason_pill_burden),
      decline_reason_many_HIV_tests=VALUES(decline_reason_many_HIV_tests),
      decline_reason_long_pills_intake=VALUES(decline_reason_long_pills_intake),
