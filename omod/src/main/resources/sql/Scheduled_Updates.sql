    ...
    insert into kenyaemr_etl.etl_laboratory_extract(
      ...
      select
        ...
        (case when o.concept_id in(5497,730,654,790,856) then o.value_numeric
         when o.concept_id in(1030,1305,1325,159430,161472,1029,1031,1619,1032,162202,307) then o.value_coded END) AS test_result,
      ...
      from encounter e
        ...
        inner join obs o on e.encounter_id=o.encounter_id and o.voided=0 and o.concept_id in (5497,730,654,790,856,1030,1305,1325,159430,161472,1029,1031,1619,1032,162202,307)
