...
--Update etl_covid_assessment
DROP PROCEDURE IF EXISTS sp_update_etl_covid-19_assessment $$
  CREATE PROCEDURE sp_update_etl_covid-19_assessment(IN last_update_time DATETIME)
  BEGIN
  SELECT "Processing covid-19 assessment", CONCAT("Time: ", NOW());
  insert into kenyaemr_etl.etl_covid_assessment(
    uuid,
    provider,
    patient_id,
    visit_id,
...
booster_dose=VALUES(booster_dose),booster_dose_verified=VALUES(booster_dose_verified),ever_tested_covid-19_positive=VALUES(ever_tested_covid-19_positive),symptomatic_before_first_visit=VALUES(symptomatic_before_first_visit),
...
covid-19_management_service_offered=VALUES(covid-19_management_service_offered),voided=VALUES(voided);
...
CREATE PROCEDURE sp_scheduled_updates()
  BEGIN
    ...
    CALL sp_update_etl_covid-19_assessment(last_update_time);
