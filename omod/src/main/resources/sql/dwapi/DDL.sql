...
DROP TABLE IF EXISTS dwapi_etl.etl_high_iit_intervention;
...
CREATE TABLE dwapi_etl.etl_patient_contact (
  ...
  CREATE TABLE dwapi_etl.etl_client_trace (
    ...
    appointment_date       DATETIME,
    voided INT(11),
    CONSTRAINT FOREIGN KEY (client_id) REFERENCES dwapi_etl.etl_patient_contact(patient_id),
    CONSTRAINT unique_uuid UNIQUE(uuid),
    INDEX(date_created),
    INDEX(id),
...
CREATE TABLE dwapi_etl.etl_PrEP_verification (
   ...
   -- ------------ create table etl_violence_reporting-----------------------
    CREATE TABLE dwapi_etl.etl_violence_reporting (
    uuid char(38),
    provider INT(11),
    patient_id INT(11) NOT NULL ,
    visit_id INT(11),
...
(
    ...
    services_referral             varchar(255),
    other_services_referral       varchar(255),
    date_created                  DATETIME NOT NULL,
    date_last_modified            DATETIME,
    voided                        INT(11),
    CONSTRAINT FOREIGN KEY (patient_id) REFERENCES dwapi_etl.etl_patient_demographics (patient_id),
...
CREATE TABLE dwapi_etl.etl_clinical_encounter (
   patient_id 			    INT(11) NOT NULL,
   visit_id 				INT(11) DEFAULT NULL,
   encounter_id 			INT(11) NOT NULL PRIMARY KEY,
   uuid 					CHAR(38) NOT NULL,
...
CREATE TABLE dwapi_etl.etl_special_clinics
(
    patient_id               INT(11)  NOT NULL,
    visit_id                 INT(11) DEFAULT NULL,
    encounter_id             INT(11)  NOT NULL PRIMARY KEY,
...
CREATE TABLE dwapi_etl.etl_kvp_clinical_enrollment
(
    patient_id                            INT(11)  NOT NULL,
    visit_id                              INT(11) DEFAULT NULL,
    encounter_id                          INT(11)  NOT NULL PRIMARY KEY,
...
CREATE TABLE dwapi_etl.etl_high_iit_intervention
(
    uuid                                                        char(38),
    provider                                                    INT(11),
    patient_id                                                  INT(11)  NOT NULL,
...
CREATE TABLE dwapi_etl.etl_home_visit_checklist
(
    uuid                              char(38),
    provider                          INT(11),
    patient_id                        INT(11)  NOT NULL,
