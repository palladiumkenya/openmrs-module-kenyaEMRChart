...
(case differentiated_care when 164942 then "Standard Care"  when 164943 then "Fast Track" when 166443 then "Health care worker Led facility ART group(HFAG)"
...
when 164946 then "Facility ART Distribution Group" end) as differentiated_care,
